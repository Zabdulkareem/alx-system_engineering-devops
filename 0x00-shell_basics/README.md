##In this folder contains a list of basic shell commands and what they do.

[Task 0]**<sub>pwd</sub> command prints out the absolute path name of the current working directory**
